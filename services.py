...
class ParserFactory:
    ...
    def create_parser() -> argparse.ArgumentParser:
        ...
        parser.add_argument('--where', help='Filter condition (e.g. "brand=apple" or "price>1000")')
...
class Processor(ABC):
    @abstractmethod
    def apply_filter(self, data: List[Dict[str, str]], column: str, operator: str, value: str) -> List[Dict[str, str]]: ...

    @abstractmethod
    def apply_aggregation(self, data: List[Dict[str, str]], column: str, operation: str) -> float: ...
